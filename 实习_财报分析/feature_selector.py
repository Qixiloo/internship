...
class FeatureSelector():
    ...
    def identify_collinear(self, correlation_threshold, one_hot=False):
        ...
        print('%s features with a correlation magnitude greater than %0.2f.\n' % (self.ops['collinear'], self.correlation_threshold))
    ...
    def identify_low_importance(self, cumulative_importance):
        ...
        #print('%d features do not contribute to cumulative importance of %0.2f.\n, they are %' % (len(self.ops['low_importance']),
                                                                                               #self.cumulative_importance,self.ops['low_importance']))
        print('%d features do not contribute to cumulative importance of %0.2f.\nThey are %s.' % (len(self.ops['low_importance']), self.cumulative_importance, self.ops['low_importance']))
    ...
    def remove(self, methods, keep_one_hot = True):
        ...
        if not keep_one_hot:
        	...
        	print('Removed %d features, they are %s' % (len(features_to_drop),features_to_drop))
